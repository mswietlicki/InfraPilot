...
public static class PromotionSeedData
{
    ...
    [
        ("Jan Kowalski", "jan.kowalski@somedomain.com"),
        ("Anna Kowalska", "anna.kowalska@somedomain.com"),
        ("Piotr Nowak", "piotr.nowak@somedomain.com"),
        ("Marta Wiśniewska", "marta.wisniewska@somedomain.com"),
        ("Sylwester Grabowski", "sylwester.grabowski@somedomain.com"),
        ("Tomasz Wójcik", "tomasz.wojcik@somedomain.com"),
        ("Katarzyna Lewandowska", "katarzyna.lewandowska@somedomain.com"),
        ("Michał Zieliński", "michal.zielinski@somedomain.com"),
    ];
        ...
        foreach (var deploy in stagingDeploys.Take(30))
        {
            ...
            var candidate = new PromotionCandidate
            {
                ...
                ExternalRunUrl = status is PromotionStatus.Deploying or PromotionStatus.Deployed
                    ? $"https://ci.somedomain.com/runs/{rand.Next(10000, 99999)}"
                    : null,
